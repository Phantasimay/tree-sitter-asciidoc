...
exports.EXTENSION_GFM =
    process.env.EXTENSION_GFM ||
    exports.EXTENSION_DEFAULT ||
    process.env.ALL_EXTENSIONS
exports.EXTENSION_TASK_LIST =
    process.env.EXTENSION_TASK_LIST ||
    exports.EXTENSION_GFM ||
    process.env.ALL_EXTENSIONS
exports.EXTENSION_STRIKETHROUGH =
    process.env.EXTENSION_STRIKETHROUGH ||
    exports.EXTENSION_GFM ||
    process.env.ALL_EXTENSIONS
exports.EXTENSION_PIPE_TABLE =
    process.env.EXTENSION_PIPE_TABLE ||
    exports.EXTENSION_GFM ||
    process.env.ALL_EXTENSIONS
exports.EXTENSION_MINUS_METADATA =
    process.env.EXTENSION_MINUS_METADATA ||
    exports.EXTENSION_DEFAULT ||
    process.env.ALL_EXTENSIONS
exports.EXTENSION_PLUS_METADATA =
    process.env.EXTENSION_PLUS_METADATA ||
    exports.EXTENSION_DEFAULT ||
    process.env.ALL_EXTENSIONS
exports.EXTENSION_TAGS =
    process.env.EXTENSION_TAGS || process.env.ALL_EXTENSIONS
exports.EXTENSION_LATEX =
    process.env.EXTENSION_LATEX ||
    exports.EXTENSION_DEFAULT ||
    process.env.ALL_EXTENSIONS
exports.EXTENSION_WIKI_LINK =
...
exports.rules = {
    ...
    _text_no_angle: $ =>
        choice($._word, punctuation_without($, ['<', '>']), $._whitespace),
    link_title: $ =>
        choice(
            seq(
                '"',
